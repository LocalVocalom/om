...
public class AppLaunchDtoV2 {
	...
	private boolean taboolaEnabled;
	
	private int taboolaInterval;
	
	public AppLaunchDtoV2(String share_text, List<NewsCategoryDto> catagory, int min, String inviteUrl, int max,
	...
	public boolean isTaboolaEnabled() {
		return taboolaEnabled;
	}

	public void setTaboolaEnabled(boolean taboolaEnabled) {
		this.taboolaEnabled = taboolaEnabled;
	}

	public int getTaboolaInterval() {
		return taboolaInterval;
	}

	public void setTaboolaInterval(int taboolaInterval) {
		this.taboolaInterval = taboolaInterval;
	}
}
